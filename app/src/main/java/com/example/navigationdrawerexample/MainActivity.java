...
public class MainActivity extends Activity
{
    ...
    public void ListNevCreate(){
        ...
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.sm_ic_login,"کارنامه من","my-record",true);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.newsletters,"افزودن محصول","reg-prod",true);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.manageprodut,"مدیریت محصولات","prod-mng",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.sm_ic_login,"___","_",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.category, "دسته بندی ","cats",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.search, "جستجو","find",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.sm_ic_login,"___","_",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.notifications, "اطلاعیه ها","news",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.rules, "شبکه های اجتماعی","neta",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.rules, "قوانین و مقررات","rouls",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.contact, "تماس با ما","contactus",false);
    ...
    private void SelectItem(String code)
    {
        ...
        switch (code) {
            case "home"://خانه
                PublicStaticValues.newpage = "bz_prods.html#sorting=1"; //+ Addres;
                break;
            case "nprofile"://ورود
                if (!IsEmptyDV("id"))
                {
                    LoadingStart();
                    PublicStaticValues.newpage = "menu.html#id=" + GetDV("id");
                }
                else
                    PublicStaticValues.newpage = "tk_login.html";
                //PublicStaticValues.newpage = "profile.htm#id=" + GetDV("id");
                break;
            case "join":
                LoadingStart();
                PublicStaticValues.newpage=PublicStaticValues.urlsite_bz + "/MobilePage/Mobile-signup.aspx";
                break;
            case "exit"://خروج
                ExitAccountMenu();
                break;
            case "my-record":// کارنامه من
                PublicStaticValues.newpage="profile.htm#id=" + GetDV("id");
                break;
            case "reg-prod":
                String ssdd=GetDV("id");
                //PublicStaticValues.newpage="http://www.bazar2020.ir/MobilePage/AddProducts2.aspx?id=5212&usrId=1" ;//+ GetDV("id");
                PublicStaticValues.newpage=PublicStaticValues.urlsite_bz + "/MobilePage/AddProducts.aspx?usrId=" + GetDV("id");
                //ul.Alert("به زودی");
                break;
            case "prod-mng"://مدیریت محصولات
                if (!IsEmptyDV("id")) {
                    LoadingStart();
                    PublicStaticValues.newpage =PublicStaticValues.urlsite_bz + "/MobilePage/ManageProducts.aspx?usrId=" + GetDV("id");
                } else {
                    PublicStaticValues.newpage = "tk_login.html";
                }
                break;
            case "cats"://دسته بندی
                PublicStaticValues.newpage="bz_pcats.html";
                break;
            case "find": //جستجو
                PublicStaticValues.newpage = "bz_search.html";
                break;
            case "news"://اطلاعیه ها
                PublicStaticValues.newpage = "tk_information.html";
                break;
            case "neta":// شبکه های اجتماعی
                PublicStaticValues.newpage= "tk_snet.html";
                break;
            case "rouls"://قوانین و مقررات
                PublicStaticValues.newpage= "tk_information_items.html#m=1&pid=spLaws";
                break;
            ...
            case "showportal"://مشاهده پرتال
                OpenChrome(PublicStaticValues.urlsite_bz );
                break;
    ...
    public void ListNevLoginLogout()
    {
        try {
            if (IsEmptyDV("nameuser"))
            {
                ...
                //ListNav_Set_Hide(lngi("my-record"),true);
                ListNav_Set_Hide(lngi("reg-prod"),true);
                ListNav_Set_Hide(lngi("prod-mng"), true);
            }
            else
            {
                ...
                //ListNav_Set_Hide(lngi("my-record"),false);
                ListNav_Set_Hide(lngi("reg-prod"),false);
                ListNav_Set_Hide(lngi("prod-mng"), false);
...
//320\473
        ...
        ReplaceFragment(WebViewFragment.newInstance("bz_actionbar.html#size="+size_header),R.id.ActionBarTools);
