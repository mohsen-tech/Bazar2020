...
public class ul {
    public static void Alert(String msg) {
        ...
        toastTV.setTextColor(Color.parseColor("#005fb5"));
        toastTV.setBackgroundColor(Color.parseColor("#FFFFFF"));
        toast.getView().setBackgroundColor(Color.parseColor("#FEFEFF"));
